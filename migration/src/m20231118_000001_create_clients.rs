        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Client::RedirectUris).json().not_null())
                    .col(ColumnDef::new(Client::GrantTypes).json().not_null())
                    .col(ColumnDef::new(Client::ResponseTypes).json().not_null())
                    .col(ColumnDef::new(Client::Scope).json().not_null())
                    .col(
